...
export default function StarRatingUser({ starRating, sumStarRating, nameProduct, reviewRating }) {
  ...
  return (
    <div className="ground-start-rating">
      <h3>
        {sumStarRating} Đánh giá {nameProduct}
      </h3>
