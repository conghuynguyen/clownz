          ...
          <div className="container-detail-products">
            <div className="group-detail">
              ...
              <div className="link-group">
                ...
                <Link to={`/product?trademark=${dataProductsId.key.replace(/ /g, '-')}`}>
                  {dataProductsId.key}
                </Link>
                <Link to={`/product-type?nsx=${dataProductsId.NSX.replace(/ /g, '-')}`}>
                  {dataProductsId.NSX}
                </Link>
              ...
              {isAdmin && token && (
                <div className="ground-btn-admin">
                  <Popconfirm
                  ...
                  <Button type="primary">
                    <Link to={`/admin-edit-product/${id_product}`}> Chỉnh sửa</Link>
                  </Button>
                </div>
              )}
