    ...
    <>
      ...
      <div className="profile">
        <div className="avatar-user">
          <img src={user.avatar} alt={user.name} onClick={() => setVisible(true)} />
        </div>
          ...
          >
            <div className="information">
              ...
              <div className="ground-information">
                  ...
                  <div className="name-information">
                    ...
                    {isNameUpdate && (
                      <Form form={form} onFinish={onChangeInformationUser}>
                        ...
                        >
                          <Input onChange={onChangeInput} defaultValue={user.name} />
                        </Form.Item>
                ...
                <div className="group-logout">
                  ...
                  <div className="logout-information">
                    <button className="inForUser" onClick={LoginOutlinedUser}>
                      Đăng xuất
                    </button>
                  </div>
                </div>
              ...
              <div className="change-information">
                <Button block type="primary" onClick={() => setIsInformation(true)}>
                  Đổi mật khẩu
                </Button>
              </div>
            </div>
