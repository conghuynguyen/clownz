...
export default function HomePage() {
  document.querySelector('title').innerHTML = 'HUY SNEAKER STORE';
  ...
  return (
    <div className="group-home">
      <div className="home">
        <Banner />
        <Trademark />
        <ProductsType data={dataProductsType} loading={loadingProductsType} />
        <SliderHome data={dataSlider} loading={loadingSlider} />
        <LatestProduct data={dataProductsList} loading={loadingProductsList} />
      </div>
    </div>
  );
}
